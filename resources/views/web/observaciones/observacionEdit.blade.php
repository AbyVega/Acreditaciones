                                    ...
                                    <form action="{{route('Observacion.update', $observacion->id)}}" method="POST" enctype="application/x-www-form-urlencoded">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="inputAddress"><h4>No.</h4></label>
                                                <input type="text" class="form-control" id="inputAddress" name="id" value="{{$observacion->id}}" readonly>
                                            </div>
                                            <div class="form-group col-md-8">
                                                <label for="inputPassword4"><h4>Indicador</h4></label>
                                                <input type="text" class="form-control" id="inputPassword4" name="indicador" value="{{$observacion->indicador}}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="inputPassword4"><h4>Observación de la Incidencia</h4></label>
                                                <textarea type="text" class="form-control" id="inputPassword4" name="observaIncidencia"
                                                          value="{{$observacion->observaIncidencia}}"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail4"><h4>Tiempo de solución</h4></label>
                                            <input type="text" class="form-control" id="inputEmail4" name="accioTomar" value="{{$observacion->tiempoSolucion}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="inputPassword4" name="proceso_id" value="{{$observacion->proceso_id}}">
                                        </div>
                                        <div class="form-group col-md-3">
