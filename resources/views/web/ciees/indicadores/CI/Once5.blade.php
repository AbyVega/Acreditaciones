<form>
    <header>
        <h2><a href="#">Servicios tecnológicos</a></h2>
    </header>
        ...
        <table class="table table-striped table-bordered tabled-condensed table-hover">
            ...
            @foreach($consultas114 as $consulta114)
                ...
                <tr>
                    ...
                    <td>
                        <form id="delete_Entidad" action="{{route('Indica12.destroy', $consulta115->id)}}" method="POST" >
                            <a href="{{route('Indica12.edit', $consulta115->id)}}">
                                <button type="button" class="btn btn-secondary">
