<form>
    <header>
        <h2><a href="#">Estrategias de difusión y promoción</a></h2>
    </header>
        ...
        <table class="table table-striped table-bordered tabled-condensed table-hover">
            ...
            @foreach($consultas51 as $consulta51)
                ...
                <tr>
                    ...
                    <td>
                        <form id="delete_Entidad" action="{{route('Indica12.destroy', $consulta51->id)}}" method="POST" >
                            <a href="{{route('Indica12.edit', $consulta51->id)}}">
                                <button type="button" class="btn btn-secondary">
